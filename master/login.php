...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="" name="f1" method="post">
      ...
      <?php
          ...
          if(!empty($_POST['masuk']))
          {
            ...
            $res=pg_query($dbconn,("Select * from auth_users where username='$username' AND id_level='4'"));
            ...
            if(pg_num_rows($res)>0)
            {
              ...
              {
                $message_ok=true;
                $_SESSION['id_users'] = $data[0];
                $_SESSION['username'] = $data[1];
                $_SESSION['id_level'] = $data[3];
                $_SESSION['user_login'] = $data[0];

                 $result=pg_query($dbconn,("UPDATE auth_users SET tanggal_login = '".date("Y-m-d")."',jam_login = '".date("H:i:s")."' WHERE id_users = '".$data[0]."'"));
	...
	<div class="login-right">
		<b>
    <span class="teks-atas"><?php echo $setting['tahun'];?></span></b><br>
