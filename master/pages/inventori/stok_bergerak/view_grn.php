         ...
         <div class="form-group">
                  ...
                  <div class="col-sm-10">
                     <?php 
                      ...
                      ?>
                      <select name='id_supplier' class='form-control' required id="supplier_po" disabled>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">                     
                      <input name='credit_term' class='form-control' value="<?php echo $data['credit_term']; ?>" disabled> hari
              ...
              <div class="form-group" >
                  ...
                  <div class="col-sm-8">
                      <input type="text" disabled name="no_invoice"  class="form-control"  value="<?php echo $data['no_invoice']; ?>">
                  </div>
                </div>
                <div class="form-group" >
                  ...
                  <div class="col-sm-8">
                      <input disabled type="text" name="tgl_invoice" value="<?php echo $data['tgl_invoice'];?>" id="datepicker3" class="form-control" required>
                  </div>
                </div>
                  ...
                  <div class="col-sm-8">                     
                      <input name='gl_no' class='form-control' value="<?php echo $data['gl_no']; ?>" disabled>
