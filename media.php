...
elseif(isset($_GET['ajax'])) {
        ...
        <div id="form-modalx" class="modal fade"></div>
...
elseif(isset($_GET['perusahaan'])) {
    include_once('config/conn.php');
    include_once('config/function.php');?>
    <link href="assets/css/dataTables.bootstrap4.min.css" rel="stylesheet">

    <?php
    include "content/perusahaan/".$_GET['perusahaan'].".php";
    ?>
    <script> 
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
        ...
        <ul class="nav navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item" id='changePass'><i class="fa fa-user"></i> Profile</a>
    ...
    <div class="app-body">
        <div class="sidebar" id="menuUtama">
    ...
    $(document).ready(function()
    {
      ...
      /*  $('#select-unit').click(function(event) {   
        if(this.checked) {
         ...
         $('#select-stest').click(function(event) {   
        if(this.checked) {
            // Iterate each checkbox
            $('.stest').each(function() {
                this.checked = true;                        
          ...
          $('#select-mtest').click(function(event) {   
        if(this.checked) {
            // Iterate each checkbox
            $('.mtest').each(function() {
                this.checked = true;                        
        ...
        $('#select-nonlab').click(function(event) {   
        if(this.checked) {
            // Iterate each checkbox
            $('.nonlab').each(function() {
                this.checked = true;                        
            });
        } else{
            $('.nonlab').each(function() {
