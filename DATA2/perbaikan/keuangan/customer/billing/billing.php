								...
								<tbody>
									...
									while($r=pg_fetch_array($tampil)){
										...
										?>
											...
											?>
											<a href="#" class="btn btn-primary btn-xs btnEditBilling $disabled" title="Edit" data-toggle="tooltip" data-placement="top" id="<?php echo $r['id'];?>"  ><i class="icon-note"></i></a>
											<a href="hapus-transaksi-invoice-detail-<?php echo "$r[id]";?>" class="btn btn-danger btn-xs $disabled" onclick="return confirm('Anda yakin ingin menghapus data ini?')" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="icon-trash"  ></i></a>
											</td>
										</tr>
										<?php
										$no++;
