					...
					<div class="card">
						...
						<div class="card-block">
							...
							<table class="table" id="myTable">
								...
								<tbody>
									<?php
									$tampil=pg_query($dbconn,"SELECT * FROM transaksi_invoice WHERE id_unit='$_SESSION[id_units]' AND waktu_input BETWEEN '$tanggal_awal2 00:00:00' AND '$tanggal_akhir2 23:59:59' ORDER BY id");
