			...
			<div class="col-md-2">
				<div class="card">
					...
					<div class="card-block">
						...
						<?php }
						if($Peringatan){ ?>
						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="btnPeringatanPasien" data-toggle="tooltip" data-placement="right" title="Peringatan"><i class="icon-arrow-right-circle"></i> Peringatan</a><br>
						<?php }
						?>
						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="btnAmbilSampel" data-toggle="tooltip" data-placement="right" title="Form Pemeriksaan"><i class="icon-arrow-right-circle"></i> Pengambilan Sampel</a><br>
						...
						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="btnOrderPasien" data-toggle="tooltip" data-placement="right" title="Order"><i class="icon-arrow-right-circle"></i> Order</a><br>

						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="btnAmbilGambar" data-toggle="tooltip" data-placement="right" title="Ambil Gambar"><i class="icon-arrow-right-circle"></i> Ambil Gambar</a><br>
						<hr><label >Histori</label><br>
						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="btnSingleTestPasien" data-toggle="tooltip" data-placement="right" title="Single Test"><i class="icon-arrow-right-circle"></i> Data Single Test</a><br>
						...
						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="btnNonLabPasien" data-toggle="tooltip" data-placement="right" title="Non-Laboratiorium"><i class="icon-arrow-right-circle"></i> Data Non Laboratiorium</a><br>
						
						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="btnMcuPasien" data-toggle="tooltip" data-placement="right" title="MCU"><i class="icon-arrow-right-circle"></i> MCU</a><br>
						<hr>
						...
						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="btnLainPasien" data-toggle="tooltip" data-placement="right" title="Pemeriksaan Lainnya"><i class="icon-arrow-right-circle"></i> Pemeriksaan Lainnya</a><br>
						...
						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="btnPemeriksaanFisik" data-toggle="tooltip" data-placement="right" title="Hasil Fisik"><i class="icon-arrow-right-circle"></i> Hasil Pemeriksaan Fisik</a><br>
						
						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="btnKesimpulanAnamnesa" data-toggle="tooltip" data-placement="right" title="Hasil Lab"><i class="icon-arrow-right-circle"></i> Kesimpulan Anamnesa</a><br>
						<hr>
