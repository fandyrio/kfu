...
<table id="example2" class="table resep_loader ">
							<thead>
								...
								<tbody>
								<?php
								$tampil=pg_query($dbconn,"select i.* from pasien_resep_order_detail i where i.id_pasien='".$id_pasien."' AND i.id_kunjungan='".$id_kunjungan."' AND i.status_proses='N' AND i.id_unit='$_SESSION[id_units]' ");
