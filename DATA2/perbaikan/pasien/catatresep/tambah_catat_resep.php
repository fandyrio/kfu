...
<input type="hidden" id="id_kategori_harga" value="<?php echo $id_kategori_harga;?>">
											...
											<tbody>
												...
												while($r=pg_fetch_array($tampil)){
													...
													<tr>
														...
														<td>
															<button class="btn btn-default btn-xs btnTambahPesanResep" id="<?php echo $r['id'];?>"><i class="icon-plus"></i></button>
														</td>
													</tr>
													<?php
												}
		...
		$('.btnTambahPesanResep').click(function(){
			var id=this.id;
			...
			$.ajax({
				...
				data: data,
				success: function(data){
					$("#data_pasien").load("tambah-catat-obat");
				}
			});
		...
		$('body').on('change', '#qty_load', function (){
             ...
             $(".resultload").load("content/pasien/catatresep/load_resep_batch.php?brand="+nama+"&dept="+departemen+"&jenis_layanan="+jenis_layanan);  
                     ...
                     if(!$(this).attr("disabled")){
                             ...
                             $.ajax({
                                           ...
                                           success: function(data) {
                                             ...
                                             $('.resep_loader').load("content/pasien/catatresep/detail_item_obat.php?id_pasien="+id_pasien+"&id_kunjungan="+id_kunjungan);
