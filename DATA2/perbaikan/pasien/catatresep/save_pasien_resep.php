...
/*
		While($data= pg_fetch_assoc($sql)){
				                ...
				                if($jlh=pg_num_rows($fifo)>0){
					               ...
					               /*pg_query($dbconn, "update pasien_resep_order set status_proses='Y' , nama_dokter = $nama_dokter where id='".$data["id_pasien_resep"]."' ");*/
				 ...
				 pg_query($dbconn, "update pasien_resep_order set status_proses='Y' , nama_dokter = $nama_dokter where id_pasien='$id_pasien' and id_kunjungan='$id_kunjungan' ");
