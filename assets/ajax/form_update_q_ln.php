<?php 
 ...
 ?>   
		  <div class="box-footer ">
                <button type="submit" class="btn btn-xs btn-info" id="cancel_update_q">Cancel</button>
                <button type="submit" class="btn btn-xs btn-primary" id="simpan_form_update_q_ln">Simpan</button>
              </div>
		
			<form id="update_quo" class="form-horizontal" method="POST" enctype="multipart/form-data" action="">
