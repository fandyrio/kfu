...
<button class="btn-xs btn-success" id="simpan_update_grn_ln">Simpan</button>
            <form method="POST" enctype="multipart/form-data" id="grn_ln_update">
						   ...
						   <div class="form-group">
							...
							<input id="check_diskon"  type="checkbox" checked name='check_diskon'>%
                             ...
                             <div class="col-sm-2">                     
                                ...
                                <input id="persen_diskon" type="text" name='diskon_persen'  required class='form-control' onchange="count_on_jumlah_grn()">
                                ...
                                <label  class="col-sm-1">Diskon Amt</label>
								 <div class="col-sm-3">                     
									<input id="diskon_amount" name='diskon_amount'  disabled class='form-control' onchange="count_on_jumlah_grn()">
						  ...
						  <div class="form-group">
							...
							<input id="check_pajak"  type="checkbox" checked name='check_pajak'>%
                             ...
                             <div class="col-sm-2">                     
                                ...
                                <input id="persen_pajak" type="text" name='pajak_persen'  required class='form-control' onchange="count_on_jumlah_grn()">
                                ...
                                <label  class="col-sm-1">Pajak Amt</label>
								 <div class="col-sm-3">                     
									<input id="pajak_amount" name='pajak_amount'  class='form-control' disabled  onchange="count_on_jumlah_grn()">
