                 ...
                 <div class="form-group">
                  ...
                  <table  class="table table-bordered table-striped">
                   ...
                   <?php
                       $no = 0;
                       $jum = 0;
                       $res=pg_query($dbconn,"Select retur_batch.*,  inv_satuan.nama  as  \"nama_satuan\" from retur_batch
                       INNER JOIN inv_satuan on inv_satuan.id=retur_batch.id_satuan 
                       WHERE retur_batch.id_ln ='".$_SESSION['id_retur_ln_temp']."'");
