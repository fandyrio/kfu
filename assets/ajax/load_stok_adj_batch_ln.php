<?php
 ...
 ?>  
          ...
          <?php
                 ...
                 $res=pg_query($dbconn,"Select v.*,a.qtyin,a.qty_out, a.no_batch, a.doc_date, a.expired_date, a.doc_no, a.manufacdate ,   
                    b.availableqty, b.availablecost,b.id_satuan, a.doc_type
                   ...
                   WHERE v.nama='".$brand."' and v.id_departemen='".$dept."' and v.id_unit='$_SESSION[id_units]' 
                   and a.id_unit='$_SESSION[id_units]' and b.id_unit='$_SESSION[id_units]'");
                    ...
                    ?>
                      ...
                      <td style="vertical-align:middle;"><input type="checkbox" id="ceklis" value="<?php echo $row['id_hdr']."_".$row['id_ln']."_".$row['id_batch']."_".$row['no_batch']."_".$row['expired_date']."_".$row['manufacdate']."_".$harga_unit."_".$row['id_satuan']."_".$row['doc_type'] ?>" 
                       ...
                       <?php echo $row['manufacdate'] ?></td>
                        ...
                        <td style="vertical-align:middle;" ><input type="hidden" /><?php echo echo $row['stockbal'] ?></td> 
