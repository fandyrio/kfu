 ...
 ?>    
		  <div class="box-footer text-right">
                ...
                <button type="submit" class="btn-xs btn-primary" id="simpan_form_tambah_q_ln">Simpan</button>
              </div>
	
			 
			<form id="new_quo" class="form-horizontal" method="POST" enctype="multipart/form-data" action="">
