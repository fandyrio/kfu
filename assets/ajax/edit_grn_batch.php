...
?> 
<button class="btn btn-xs btn-danger text-right" id="cancel_grn_batch_directly_edit">Cancel</button>
<button class="btn btn-xs btn-success text-right" id="simpan_grn_batch_directly_edit">Simpan</button><br><br>
            <form method="POST" enctype="multipart/form-data" id="grn_batch_directly_temp_edit">
             ...
             <input type="hidden" name='id_ln'  class='form-control' readonly value="<?php echo $data['id_ln'];?>">
