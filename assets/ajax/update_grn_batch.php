...
?>
                  ...
                  <div class="col-sm-6">
                  <!--  <button  id="add_grn_batch_update" class="btn btn-xs btn-primary">Tambah</button> -->
                 </div>
                  <div class="col-sm-6">
                  ...
                  <table  class="table table-bordered table-striped">
                   ...
                   <?php
                       ...
                       INNER JOIN inv_satuan on inv_satuan.id=grn_batch.id_satuan WHERE grn_batch.id_ln='".$_SESSION['id_grn_ln_temp']."'";
                        ...
                        $no++;
						 //$jum +=;
                           ...
                           ?>
                            ...
                            <a id="<?php echo $row['id'] ?>" class="btn btn-warning btn-xs edit_grn_batch_update"><i class="icon-note" aria-hidden="true"></i></a>
                            <a id="<?php echo $row['id'];?>" onclick="return confirm('Yakin ingin menghapus data')" class="btn btn-danger btn-xs hapus_batch_ln_update"><icon class="icon-trash" aria-hidden="true"></span></a>
              </td> -->
                              </tr>
