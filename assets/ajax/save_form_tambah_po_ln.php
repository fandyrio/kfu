<?php 
          ...
          $res=pg_query($dbconn,"INSERT INTO po_ln (id_hdr,nama_brand, jumlah, id_satuan, harga_unit,total_harga, komen, diskon_persen, diskon_amt, pajak_persen, pajak_amt, nett_total, id_inv  ) 
			VALUES(
			'".$_SESSION['id_po_hdr']."',
			'".$nama_brand."',
			'".$jumlah."',
			...
			/*var_dump("INSERT INTO po_ln (id_hdr,nama_brand, jumlah, id_satuan, harga_unit,total_harga, komen, diskon_persen, diskon_amt, pajak_persen, pajak_amt, nett_total, id_inv  ) 
			VALUES(
			'".$_SESSION['id_po_hdr']."',
			'".$nama_brand."',
			'".$jumlah."',
