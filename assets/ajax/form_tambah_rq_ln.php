...
<button class="btn btn-xs btn-danger" id="cancel_form_rq">Cancel</button>
<button class="btn btn-xs btn-success" id="simpan_form_rq_ln">Simpan</button>
 
            <form method="POST" class="form-horizontal" enctype="multipart/form-data" id="form_rquo">
