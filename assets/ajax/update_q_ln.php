                ...
                <Button  class="btn btn-xs btn-primary"  id="update_add_q">Tambah</Button>
                     ...
                     ?>
                       <tr>
                        ...
                        <td style="vertical-align:middle;"><?php echo number_format($row["net_total"],0,',','.') ?></td>
                            ...
                            <a id="<?php echo $row['id'] ?>" class="btn btn-warning btn-xs edit_update_quotation"><i class="icon-note"></i></a>
                            <a id="<?php echo $row['id'];?>" onclick="return confirm('Yakin ingin menghapus data')" class="btn btn-danger btn-xs hapus_update_quotation"><i class="icon-trash"></i></a>
                        </td>
