...
?>     
		  <div class="box-footer text-right">
                <button type="submit" class="btn btn-xs btn-danger" id="cancel_grn_ln">Cancel</button>
                <button type="submit" class="btn btn-xs btn-primary" id="simpan_edit_grn_ln">Simpan</button>
              </div>
			...
			<div class="form-group row">
                 ...
                 <div class="form-group row">
                            <label  class="col-sm-2">Harga Unit</label>
                             <div class="col-sm-3">                     
                                <input id="harga_unit" name='harga_unit'  value="<?php echo number_format($data['harga_unit'], 0, ',', '.');  ?>" class='form-control' onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);count_grn();">
                                ...
                                <label  class="col-sm-1">Gross</label>
								 <div class="col-sm-4">  
                 <input id="gross_po" name='gross_total'  value="<?php echo $data['gross_total'] ?>"  type="hidden" class='form-control text-right' readonly>
                  <input id="gross_po_show" name='gross_po_show' readonly  class='form-control text-right'  value="<?php echo number_format($data['gross_total'], 0, ',', '.');  ?>" >                   
