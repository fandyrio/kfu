...
<button class="btn btn-xs btn-danger" id="cancel_update_po">Cancel</button>
<button class="btn btn-xs btn-success" id="simpan_update_po_ln">Simpan</button>
            <form method="POST" class="form-horizontal" enctype="multipart/form-data" id="update_po_ln">
