...
?>                 <div class="form-horizontal">
                     <div class="form-group row">
                        <div class="col-md-6">
                          <button  id="add_buka_stok_batch" class="btn btn-xs btn-primary">Tambah</button>
                        </div>
                        ...
                        $no++;
						 //$jum +=;
                           ...
                           ?>
                            ...
                            <a id="<?php echo $row['id'] ?>" class="btn btn-warning btn-xs edit_bs_batch"><i class="icon-note"></i></a>
                            <a id="<?php echo $row['id'];?>" onclick="return confirm('Yakin ingin menghapus data')" class="btn btn-danger btn-xs hapus_bs_batch"><i class="icon-trash"></i></a>
                               </td>
