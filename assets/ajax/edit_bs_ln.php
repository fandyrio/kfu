...
?>     
                <button type="submit" class="btn btn-xs btn-info" id="cancel_bs_ln">Cancel</button>
                <button type="submit" class="btn btn-xs btn-primary" id="simpan_edit_bs_ln">Simpan</button>
             

			<form id="edit_bs_ln" class="form-horizontal" method="POST" enctype="multipart/form-data" action="">
