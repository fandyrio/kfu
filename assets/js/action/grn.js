  ...
  /*simpan terima barang header*/
            $('body').on('click', '#simpan_grn_hdr', function (){
              ...
              var CANSAVE = false;
               var ln = $("#jlh_ln").val();
              if(parseInt(ln)==0){
                  alert("belum ada isi item tambah barang");
                  return false;
              }            
              ...
              if(CANSAVE){
                ...
                //action
                 var data = $("#grn_hdr").serialize();
                    var gross_total_titik = $("[name=gross_total]").val();                
                    var gross_total = gross_total_titik.replace('.', "");
