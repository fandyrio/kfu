<header class="page-header">
	<div class="container-fluid">
        <h2 class="no-margin-bottom">Karyawan</h2>
		<ul class="breadcrumb">
							...
							?>
								<tr>
									...
									<td class="text-center">
										<a href="media.php?content=karyawan&modul=data&update&id=<?php echo $row['id'] ?>" class="btn btn-warning btn-xs btn-flat"><i class="fa fa-eye"></i></a>
