<?php
	...
	$harga_modal=formatRupiah($data['harga_modal']);
?>  
...
<ul class="nav nav-tabs" role="tablist">
	...
	<li class="nav-item">
		<a class="nav-link" data-toggle="tab" href="#bar" role="tab" aria-controls="bar">Reference Range</a>
	</li>	
</ul>
...
<div class="card-footer">
	 <button type="button" value="batal" class="btn btn-sm btn-primary " onClick="window.location='media.php?content=analysis';" >Kembali</button>
</div>
