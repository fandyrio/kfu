							...
							while ($row=pg_fetch_assoc($res)) {
								...
								<tr>
									...
									<td class="text-center" style="vertical-align:middle;">
										<a id="<?php echo $row['id']?>" class="btn btn-warning btn-xs btn-flat btnUpdateTindakan"><i class="fa fa-eye"></i></a>
        ...
        $('#btnTambahTindakan').click(function()
        {
            ...
            var total = []
	         ...
	         $.ajax({
	            type: "POST",
	            url: "media.php?ajax=simpan_tindakan&act=baru",
	            data:{  
	                    check:checkbox1,   
	                    total:total,
	            ...
	            success: function(data){
	              $("#nonlab").load("media.php?ajax=data_tindakan");
	            }
	          });   
        ...
        $('.btnHapus').click(function()
        {
        	 if (confirm('Apakah Anda Ingin Menghapus?')) {
        	 	var data = $(this).attr('id'); 
		       	...
		       	$.ajax({  
		            type: "POST",
		            url: 'media.php?ajax=simpan_tindakan&act=delete',
		            data: {id:data},
		            success: function () {
		                $("#nonlab").load("media.php?ajax=data_tindakan");
		            }
		...
		$('.btnUpdateTindakan').click(function(){
          var data = $(this).attr('id');
           ...
           $("#nonlab").load("media.php?ajax=data_tindakan&update&id="+data);
         ...
         $('#kembali_tindakan').click(function(){
          ...
          $('#btnSimpanEditTindakan').click(function(){
            ...
            $.ajax({  
                type: "POST",
                url: 'media.php?content=perusahaan&modul=simpan_tindakan&act=edit',
                data: data,
                success: function () {
                    $("#nonlab").load("media.php?ajax=data_tindakan");
                }
