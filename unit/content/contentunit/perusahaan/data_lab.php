                     ...
                     ?>
                       <tr>
                        ...
                        <a id="<?php echo $row['id']?>" class="btn btn-warning btn-xs btn-flat btnEditLab"><i class="fa fa-edit"></i></a>
                         <a id="<?php echo $row['id_lab_analysis']?>" class="btn btn-warning btn-xs btn-flat btnViewLab"><i class="fa fa-eye"></i></a>
      ...
      <script>
        $('#btnTambahlab').click(function()
        {
          var checkbox1 = []
            ...
            $.ajax({
              type: "POST",
              url: "media.php?ajax=simpan_lab&act=baru",
              data:{  
                      check:checkbox1,   
                      total:total
               },
              success: function(data){
                ...
                $("#lab").load("media.php?ajax=data_lab");
              }
            });
        ...
        $('.btnViewLab').click(function(){
          var data = $(this).attr('id');
           ...
           $("#lab").load("media.php?ajax=data_lab&view&id="+data);
        ...
        $('.btnEditLab').click(function(){
          var data = $(this).attr('id'); 
           ...
           $("#lab").load("media.php?ajax=data_lab&edit&id="+data);
