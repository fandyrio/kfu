...
<button class="btn-xs btn-danger" id="cancel_update_rq">Cancel</button>
<button class="btn-xs btn-success" id="simpan_form_update_rq_ln">Simpan</button>
            <form method="POST" enctype="multipart/form-data" id="update_rquo">
