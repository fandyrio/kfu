...
?>     
		  <div class="box-footer text-right">
                <button type="submit" class="btn-xs btn-info" id="cancel_grn_ln_update">Cancel</button>
                <button type="submit" class="btn-xs btn-primary" id="simpan_edit_grn_ln_update">Simpan</button>
              </div>
