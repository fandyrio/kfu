          ...
          <?php
                 ...
                 $take_n = $_GET['ambil_edit'];
                 
                 $res=pg_query($dbconn,"Select grn_hdr.*, grn_batch.no_batch, grn_batch.expired_date,  grn_batch.manufacdate,grn_batch.nama_brand,grn_batch.id_satuan, grn_ln.harga_unit, grn_ln.price,grn_batch.qty
                  from grn_hdr
                  INNER JOIN grn_ln on grn_ln.id_grn_hdr=grn_hdr.id
                  INNER JOIN grn_batch on grn_batch.id_grn_ln=grn_ln.id
                   WHERE grn_batch.nama_brand='".$nama_brand."'");
                 ...
                 while ($row=pg_fetch_assoc($res)) {
                      ...
                      <td style="vertical-align:middle;"><input type="checkbox" id="ceklis" value="<?php echo $row['no_batch']."_".$row['expired_date']."_".$row['manufacdate']."_".$row['harga_unit']."_".$row['id_satuan'] ?>" 
                        name="checkbox[]"/></td>
