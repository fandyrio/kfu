...
<button class="btn-xs btn-danger" id="cancel_bs_ln">Cancel</button>
<button class="btn-xs btn-success" id="simpan_bs_ln">Simpan</button>
            <form method="POST" enctype="multipart/form-data" id="fsimpan_bs_ln">
