<button  id="grn_load" class="btn-xs btn-warning">Load</button>
                <button  id="update_add_grn" class="btn-xs btn-primary">Tambah</button>
                   ...
                   <?php
                       ...
                       while ($row=pg_fetch_assoc($res)) {
						...
						$totalgross += $row["gross_total"];
                           ?>
                             <tr id="<?php echo $row['id_grn_ln']; ?>" data="<?php echo $row['id_satuan']."_".$row['nama_satuan']; ?>" nama="<?php echo $row['nama_brand']; ?>" >
                            ...
                            <a id="<?php echo $row['id'];?>" onclick="return confirm('Yakin ingin menghapus data')" class="btn btn-danger btn-xs hapus_grn_ln_update"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
							</td>
