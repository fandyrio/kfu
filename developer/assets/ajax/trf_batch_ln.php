                ...
                <input name='terms' value="<?php echo $_SESSION['nama_brand_trf']; ?>" class='form-control' id="batch_nama" readonly> 
                  ...
                  <table  class="table table-bordered table-striped">
                   ...
                   <?php
                       $no = 0;
                       $totalgross = 0;
                       $res=pg_query($dbconn,"Select stok_trf_batch_temp.*, inv_satuan.nama  as  \"nama_satuan\" from stok_trf_batch_temp
                       INNER JOIN inv_satuan on inv_satuan.id=stok_trf_batch_temp.id_satuan WHERE stok_trf_batch_temp.id_users='".$_SESSION['id_users']."' and stok_trf_batch_temp.id_ln='".$_SESSION['id_trf_ln_temp']."'");
