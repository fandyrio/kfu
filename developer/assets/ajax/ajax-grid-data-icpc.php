...
$query=pg_query($dbconn, $sql) or die("assets/ajax/ajax-grid-icpc.php: get InventoryItems");
...
if( !empty($requestData['search']['value']) ) {
    ...
    $query=pg_query($dbconn, $sql) or die("assets/ajax/ajax-grid-icpc.php: get PO");
    ...
    $query=pg_query($dbconn, $sql) or die("assets/ajax/ajax-grid-icpc.php: get PO"); // again run query with limit
...
while( $row=pg_fetch_assoc($query) ) {  // preparing an array
    ...
    $nestedData[] = '<td><center>
                     <a href="media.php?inventori=icpc&modul=data&update&id='.$row['id'].'"class="btn btn-sm btn-flat btn-warning btn-xs"> <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> </a>
                     <a href="media.php?inventori=icpc&modul=hapus&id='.$row['id'].'"  class="btn btn-sm btn-flat btn-danger btn-xs"> <span class="glyphicon glyphicon-trash" aria-hidden="true"></span> </a>
                     </center></td>';       
