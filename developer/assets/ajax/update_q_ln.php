                ...
                <Button  class="btn-xs btn-primary"  id="update_add_q">Tambah</Button>
             ...
             <?php
                 $no = 0;
                 $res=pg_query($dbconn,"Select q_ln.*, inv_satuan.nama  as  \"nama_satuan\" from q_ln  								
								INNER JOIN inv_satuan on inv_satuan.id=q_ln.id_satuan 
								WHERE q_ln.id_hdr='".$_SESSION['id_q_hdr']."'");
                     ...
                     ?>
                       <tr>
                        ...
                        <td style="vertical-align:middle;"><?php echo number_format($row["net_total"],0,',','.') ?></td>
                            ...
                            <a id="<?php echo $row['id'] ?>" class="btn btn-warning btn-xs edit_update_quotation"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
                            <a id="<?php echo $row['id'];?>" onclick="return confirm('Yakin ingin menghapus data')" class="btn btn-danger btn-xs hapus_update_quotation"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                        </td>
