<?php
include "../queue/apps/mysql_connect.php";
    ...
    <div class="container" style="margin-top:5%;">
    	<center>
	    	<div class="blog-header">
			    <img src="../images/logo_klinik.jpg" width="200px;" style="margin: 8px;">
				<h3 style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;"><b>Selamat datang di Klinik Kimia Farma</b></h3>
		    </div>
	    </center>
	    ...
	    <div class="audio">
			...
			<audio id="suarabelloket1" src="../queue/audio/new/umum_1.MP3"></audio> 
			<audio id="suarabelloket2" src="../queue/audio/new/umum_2.MP3"></audio> 
			<audio id="suarabelloket3" src="../queue/audio/new/umum_3.MP3"></audio> 
			<audio id="suarabelloket4" src="../queue/audio/new/gigi.MP3"></audio> 
      ...
      <footer class="footer">
        ...
        <div id="test_berjalan" style="height:40px;background-color:blue;color:white;margin-top:20%;;font-size:20px;">
        	<marquee><b>TERIMA KASIH TELAH BERKUNJUNG KE KLINIK KIMIA FARMA 0034 DENPASAR, SEMOGA LEKAS SEMBUH</b></marquee>
        </div>
						...
						loket = '<div class="col-md-3">'+
									'<div class="'+ i +
									 ' jumbotron" style="padding-top:20px;padding-bottom:20px; ">'+
										...
										'<button class="btn btn-lg btn-primary" style="font-size:3em" type="button"><span class="glyphicon glyphicon-credit-card">&nbsp;</span>POLI '+ i +'</button>'+
									'</div>'+
								'</div>';
						$(".loket").append(loket);
					}
