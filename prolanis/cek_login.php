...
if(isset($_POST['username']) && isset($_POST['password']))
{
	...
	$result=pg_query($dbconn,"SELECT a.id_users, a.username, a.maks_diskon FROM auth_users a, master_karyawan_unit b 
								WHERE a.username='$username' and a.password='$password' 
									AND a.id_karyawan=b.id_karyawan AND b.id_unit='$_POST[id_unit]'");
	...
	{	
		...
		$_SESSION['pro_user']    = $row['id_users'];
		$_SESSION['id_session']    = $sid;
		$_SESSION['id_branch']      = $_POST['id_unit'];
