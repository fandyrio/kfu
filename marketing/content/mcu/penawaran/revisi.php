    ...
    <div class="card-header">
      ...
      <div class="col-md-12 card-body" >
            ...
            <form role="form" action="media.php?content=mcu&modul=simpan&act=revisi" method="post">
             ...
             $id_users =$_SESSION['login_user'];
              ...
              <div class="form-group row">
                  ...
                  <?php echo "<b>NB</b> Anda Hanya diperbolehkan maksimal diskon ".$_SESSION['maks_diskon']."%"; ?>
                  </div>
