...
<ol class="breadcrumb">
	...
	<li class="breadcrumb-item active">Activation Type</li>
</ol>
				...
				<div class="card">
					...
					<div class="card-block">
						<table class="table  table-condensed" id="myTable">
							...
							<tbody>
								<?php
								$tampil=pg_query($dbconn,"SELECT * FROM master_mt_activity_type ORDER BY id DESC");
								...
								while($r=pg_fetch_array($tampil)){
									...
									<tr>
										...
										<td>
											...
											<a 	href="aksi-hapus-activity-type-<?php echo $r['id'];?>" onclick="return confirm('Anda yakin ingin menghapus data ini?')">
