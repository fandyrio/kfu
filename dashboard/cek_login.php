...
if(isset($_POST['username']) && isset($_POST['password']))
{
	...
	$result=pg_query($dbconn,"SELECT a.id_users, a.username FROM auth_users a, master_karyawan_unit b WHERE a.username='$username' and a.password='$password' AND a.id_karyawan=b.id_karyawan");
