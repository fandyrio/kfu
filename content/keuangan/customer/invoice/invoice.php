...
if(isset($_GET['tanggal_awal'])){
	...
	$tanggal_awal=date('d-m-Y', strtotime('0 days'));
								...
								<div class="form-group row">
									...
									<div class="col-sm-2">
										<div class="input-group">
											...
											<input id="datepicker" type="text" class="form-control date" name="tanggal_awal" value="<?php echo $tanggal_awal;?>">
										</div>
									</div>
									...
									<div class="col-sm-2">
										<div class="input-group">
											<span class="input-group-addon" id="basic-addon1"><i class="icon-calendar"></i></span>
											<input id="datepicker2" type="text" class="form-control date" name="tanggal_akhir" value="<?php echo $tanggal_akhir;?>">
										</div>
									</div>
									...
									<div class="col-sm-2">
										<select name="id_status" class="form-control">
											<option value="0" <?php if($id_status==0){echo "selected";}?>>Semua</option>
											<option value="1" <?php if($id_status==1){echo "selected";}?>>Lunas</option>
											<option value="2" <?php if($id_status==2){echo "selected";}?>>Belum Dibayar</option>
										</select>
									</div>
									...
									<a href="content/keuangan/customer/invoice/cetak_rekap_invoice.php?tanggal_awal=<?php echo $tanggal_awal2;?>&tanggal_akhir=<?php echo $tanggal_akhir2;?>" class="btn btn-danger btn-xs" style="margin-right:10px;" name="print" ><i class="fa fa-print"></i> Print</a>
								</div>
							</form>
									...
									while($r=pg_fetch_array($tampil)){
										...
										<tr>
											...
											<td>
												...
												if($r['status_bayar']=='N'){
												?>
												<a href="tambah-keuangan-customer-payment-<?php echo $r['no_invoice'];?>-<?php echo $r['id'];?>" class="btn btn-success btn-xs" title="Pembayaran" data-toggle="tooltip" data-placement="top"><i class="icon-calculator"></i></a>
												<?php
												}
												?>
											</td>
