...
if (empty($_SESSION['login_user'])){
	...
	elseif ($module=='keuangan_customer_billing' AND $act=='input'){
		...
		$dt = pg_fetch_assoc(pg_query($dbconn,"SELECT * FROM transaksi_invoice WHERE id='$id_invoice'"));
		...
		include "../../../../data/api_post_tindakan.php";
