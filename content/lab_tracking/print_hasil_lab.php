...
error_reporting(0);
	...
	$query="SELECT * from pasien_hasillab_detail  WHERE id_hasillab='$id' ";
...
?>
										...
										<table id="head_form">
											<tr>
												<td style="width:100px;">Tanggal Periksa</td>
								...
								<?php
								$no=1;
								$q=pg_query("select * from pasien_hasillab_detail where id_hasillab=$_GET[id]");
								//$pld=pg_fetch_assoc($q);
										
									$qp=pg_query("select distinct id_lab_group from pasien_hasillab_detail where id_hasillab=$_GET[id]");	
