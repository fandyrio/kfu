							...
							<form method="get" class="form-horizontal">
								...
								<label class="col-sm-1 form-control-label" >Cabang</label>
									...
									<div class="col-sm-2">
										...
										<input type="hidden" name="id_unit" value="<?php echo $_SESSION['id_units'] ?>">
									</div>
...
$checkDokter=pg_query("SELECT id_dokter from antrian where id_pasien='$d[id]' and status_antrian='Y' and status_aktif='Y'");
$fetchDataDokter=pg_fetch_assoc($checkDokter);

if($fetchDataDokter['id_dokter']=="")
{
	$jumlahDokter=0;
}
else
			...
			<div class="col-md-2">
				<div class="card">
					...
					<div class="card-block">
						...
						<?php }
						if($Keluhan){ ?>
						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="btnKeluhanPasien" data-toggle="tooltip" data-placement="right" title="Anamnesa/Keluhan"><i class="icon-arrow-right-circle"></i> Anamnesa</a><br>
						<?php }
						if($Anamnesa){ ?>
						<a href="#" style="display:none;" id="<?php echo $_GET['no_rm'];?>" class="btnAnamnesaPasien" data-toggle="tooltip" data-placement="right" title="Anamnesa"><i class="icon-arrow-right-circle"></i> Anamnesa</a>			
						<?php }
						...
						if ($DiagnosaIcpc){
						?>
						<a href="#" style="display:none;" id="<?php echo $_GET['no_rm'];?>" class="btnDiagnosaPasienIcpc" data-toggle="tooltip" data-placement="right" title="Diagnosa ICPC"><i class="icon-arrow-right-circle"></i> Diagnosa ICPC</a>	
						<?php 
						}

						if ($Lab_Order){
						?>
						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="btnOrderPasien" data-toggle="tooltip" data-placement="right" title="Order"><i class="icon-arrow-right-circle"></i> Tindakan Medis</a><br>
						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="btnFormPemeriksaan" data-toggle="tooltip" data-placement="right" title="Form Pemeriksaan"><i class="icon-arrow-right-circle"></i> Form Pemeriksaan Lab.</a><br>
						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="btnManualLab" data-toggle="tooltip" data-placement="right" title="Hasil Lab"><i class="icon-arrow-right-circle"></i> Hasil Lab</a>
						<a style="display:none;" href="#" id="<?php echo $_GET['no_rm'];?>" class="btnResepPasien" data-toggle="tooltip" data-placement="right" title="Resep"><i class="icon-arrow-right-circle"></i> 
						Tebus Resep</a><br>
						<?php 
						}
						...
						if ($CatatResep){
						?>		
							<a href="#" id="<?php echo $_GET['no_rm'];?>" class="catatResep" data-toggle="tooltip" data-placement="right" title="Hasil Fisik"><i class="icon-arrow-right-circle"></i> Catat Resep</a>	
						...
						<a style="display:none;" href="#" id="<?php echo $_GET['no_rm'];?>" class="btnHasilLabPasien" data-toggle="tooltip" data-placement="right" title="Hasil Lab"><i class="icon-arrow-right-circle"></i> Hasil Lab</a><br>
						...
						<a style="display:none;" href="#" id="<?php echo $_GET['no_rm'];?>" class="btnKesimpulanAnamnesa" data-toggle="tooltip" data-placement="right" title="Hasil Lab"><i class="icon-arrow-right-circle"></i> Kesimpulan Anamnesa</a>
						...
						<a style="display:none;" href="data/phr.php?id=<?php echo $_GET['no_rm']; ?>" id="<?php echo $_GET['no_rm'];?>" data-toggle="tooltip" data-placement="right" title="Hasil Lab"><i class="icon-arrow-right-circle"></i> Kirim PHR</a>	
						<?php }?>					
						<hr>

						<?php
						if($Billing){ ?>
						<label style="display:;">Billing</label><br>
						
						
						<a style="display:;" href="keuangan-customer-billing-<?php echo $_GET['no_rm'];?>" data-toggle="tooltip" data-placement="right" title="Billing"><i class="icon-arrow-right-circle"></i> Billing</a>
						<?php }?><br>
						<hr>
						<?php
						if($_SESSION['id_level']==2 || $_SESSION['id_level']==4){ 
						?>
						<label style="display:;">Dokumen</label><br>
						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="suratKeteranganSehat" data-toggle="tooltip" data-placement="right" title="Surat Keterangan Sehat"><i class="icon-arrow-right-circle"></i> Surat Keterangan Sehat</a><br>
						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="suratKeteranganSakit" data-toggle="tooltip" data-placement="right" title="Surat Keterangan Sakit"><i class="icon-arrow-right-circle"></i> Surat Keterangan Sakit</a><br>
						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="suratBebasNarkoba" data-toggle="tooltip" data-placement="right" title="Surat Bebas Narkoba"><i class="icon-arrow-right-circle"></i> Surat Keterangan Bebas Narkoba</a><br>
						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="suratRujukan" data-toggle="tooltip" data-placement="right" title="Surat Rujukan"><i class="icon-arrow-right-circle"></i> Surat Rujukan</a><br>
						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="inform_consent" data-toggle="tooltip" data-placement="right" title="Inform Consent"><i class="icon-arrow-right-circle"></i> Inform Consent</a><br>
						<hr />

						<label>Image</label><br />
						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="uploadImage" data-toggle="tooltip" data-placement="right" title="Hasil Fisik"><i class="icon-arrow-right-circle"></i> Upload Foto Hasil Pemeriksaan</a><br>
						
						<hr />

						<label style="display:none;">Histori</label><br>
						<a style="display:none;" href="#" id="<?php echo $_GET['no_rm'];?>" class="btnSingleTestPasien" data-toggle="tooltip" data-placement="right" title="Single Test"><i class="icon-arrow-right-circle"></i> Data Laboratorium</a><br>
						...
						<a style="display:none;" href="#" id="<?php echo $_GET['no_rm'];?>" class="btnNonLabPasien" data-toggle="tooltip" data-placement="right" title="Non-Laboratiorium"><i class="icon-arrow-right-circle"></i> Data Tindakan</a><br>
						<?php }?>
...
<div class="modal fade melayang2" id="data_perhatian" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
	<div class="modal-dialog modal-warning" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				if($c['tot']>0 AND $c2['tot']>0){
				?>
				<button type="button" id="dialog-ok" class="close">
			...
			<div class="modal-body">
				<table class="table">
					...
					<tbody>
						<?php
						$tampil=pg_query($dbconn,"SELECT p.*, pk.nama as nama_perhatian FROM pasien_perhatian p
							join master_perhatian_kategori pk on pk.id=p.id_kategori_perhatian
							WHERE p.id_pasien='$id_pasien' AND status_aktif='Y' AND status_hapus='N' ORDER BY id DESC");
						while($r=pg_fetch_array($tampil)){
							$a=pg_fetch_array(pg_query($dbconn,"SELECT code FROM master_tbl_atccode WHERE id='$r[id_kode_atc]'"));
							echo"
							<tr>
								
								<td>$r[nama_perhatian] - $r[catatan] - $r[judul]</td>
							</tr>
							";
						}
						?>
...
$(document).ready(function()
{
	var jumlahDokter="<?php echo $jumlahDokter ?>";
	
	if(jumlahDokter==0)
	{
		alert("MAAF, PASIEN TIDAK MEMILIKI DOKTER PEMERIKSA, HARUS MELEWATI PEMANGGILAN ANTRIAN");
		history.go(-1);
	}
});
