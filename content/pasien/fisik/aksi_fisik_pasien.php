...
if (empty($_SESSION['login_user'])){
							...
							<div class="form-group row">
								...
								<div class="col-md-2">
									<?php
										...
										{
											?>
											<input type="text" class="form-control col-md-6" style="float:left;" name="systol#<?php echo $r['id'];?>" placeholder="Systol">
											<input type="text" class="form-control col-md-6" style="float:left;" name="diastol#<?php echo $r['id'];?>" placeholder="Diastol">
											<?php
										}
										else
										{
	...
	elseif ($module=='fisik' AND $act=='input'){
		...
		foreach($_POST['checked'] as $key => $value){
			...
			if($id==4)
			{
				$systol=$_POST['systol#'.$value];
				$diastol=$_POST['diastol#'.$value];
				$nilai=$systol.'/'.$diastol;
			}
			else
			{
