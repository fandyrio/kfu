		...
		<div class="row">
			<div class="col-md-12">
				...
				<table class="table">
					...
					<tbody>
						<?php
							$tampil=pg_query($dbconn,"SELECT * FROM pasien_form WHERE id_pasien='$id_pasien' AND id_unit='$_SESSION[id_units]'  ORDER BY id DESC");
							$no=1;
							while($r=pg_fetch_array($tampil)){
								...
								<tr>
									...
									<td>
										<button type="button" class="btn btn-info btn-xs btnView" id="<?php echo $r['id'];?>" title="Edit"><i class="icon-eye"></i></button>
...
$(function () {
	...
	$('.btnView').click(function()
	{
		...
		$.ajax({
			type: 'POST',
			url: 'content/pasien/form/view.php',
			data : dataString2,
			success: function(msg){
				$("#data_form").html(msg);
