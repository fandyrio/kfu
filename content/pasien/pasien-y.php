			...
			<div class="col-md-2">
				<div class="card">
					...
					<div class="card-block">
						...
						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="btnDiagnosaPasienIcpc" data-toggle="tooltip" data-placement="right" title="Diagnosa ICPC"><i class="icon-arrow-right-circle"></i> Diagnosa ICPC</a><br>	
						...
						Catat Resep</a><br>
						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="btnOrderPasien" data-toggle="tooltip" data-placement="right" title="Order"><i class="icon-arrow-right-circle"></i> Order Lab & Tindakan</a>
						...
						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="suratKeteranganSehat" data-toggle="tooltip" data-placement="right" title="Hasil Fisik"><i class="icon-arrow-right-circle"></i> Surat Keterangan Sehat</a><br>
						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="suratKeteranganSakit" data-toggle="tooltip" data-placement="right" title="Hasil Fisik"><i class="icon-arrow-right-circle"></i> Surat Keterangan Sakit</a><br>
						<a href="#" id="<?php echo $_GET['no_rm'];?>" class="suratBebasNarkoba" data-toggle="tooltip" data-placement="right" title="Hasil Fisik"><i class="icon-arrow-right-circle"></i> Surat Keterangan Bebas Narkoba</a><br>
						<hr />
					...
					<tbody>
						...
						while($r=pg_fetch_array($tampil)){
							...
							<tr>
								...
								<td>$r[nama_perhatian] - $r[catatan]</td>
							</tr>
							";
						}
						?>
