						...
						<tbody>
							<?php
								...
								while($r=pg_fetch_array($tampil)){
									...
									$a=pg_fetch_array(pg_query($dbconn,"SELECT nama_sympton FROM master_sympton_indo WHERE id='$r[id_symptom]'"));
										...
										<td>
												...
												<?php
													...
													while($data = pg_fetch_array($ap)){
														$nmp=pg_fetch_array(pg_query($dbconn,"SELECT * from master_sympton_indo WHERE id='$data[id_symptom]'"));
