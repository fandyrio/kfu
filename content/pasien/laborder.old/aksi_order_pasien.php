...
if (empty($_SESSION['login_user'])){
	...
	elseif ($module=='order' AND $act=='inputform'){
		...
		<div class="card">
			...
			<div class="card-block">
				<div class="row">
					...
					<div class="col-md-5">
						<fieldset>
							<legend>Daftar Lab Analisis</legend>
							<ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#tabkiri1" role="tab" aria-controls="tabkiri1">Analisis dan Pengujian</a>
                                </li>
                                 <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tabkiri2" role="tab" aria-controls="tabkiri2">Group</a>
                                </li>
                            </ul>
							<div class="tab-content">
								<div class="tab-pane active" id="tabkiri1" role="tabpanel" style="overflow-y: scroll;">
									...
									<div class="form-group row">
										...
										<div class="col-md-8">
											<select name="id_specimen" id="id_specimen" class="form-control">
												<option value="0">No Selection</option>
												<?php
												$tampil=pg_query($dbconn,"SELECT * FROM lab_specimen");
												while($r=pg_fetch_array($tampil)){
													echo"<option value='$r[id]'>$r[nama]</option>";
												}
												?>
									...
									<div class="form-group row">
										...
										<div class="col-md-8">
											<select name="id_kategori" id="id_kategori" class="form-control">
												<option value="0">No Selection</option>
												<?php
												$tampil=pg_query($dbconn,"SELECT * FROM lab_kategori");
												while($r=pg_fetch_array($tampil)){
													echo"<option value='$r[id]'>$r[nama]</option>";
												}
												?>
										...
										<table class="table">
											...
											<tbody>
												...
												$id_unit= $_SESSION['id_units'];
								                 $res=pg_query($dbconn,"Select id, id_lab_analysis from lab_analysis_unit  where id_unit='$id_unit' order by id asc");
								                 ...
								                 while ($row=pg_fetch_assoc($res)) {
													...
													<tr>
														...
														<td>
															<button class="btn btn-default btn-xs btnTambahPesanAnalysis" id="<?php echo $view['id'];?>"><i class="icon-plus"></i></button>
														</td>
													</tr>
													<?php
												}
									...
									<div class="form-group data-lab2">
										<table class="table">
											...
											<tbody>
												<?php
												$id_unit= $_SESSION['id_units'];
												$tampil=pg_query($dbconn,"SELECT * FROM lab_analysis_group_unit WHERE id_unit='$id_unit' ");

												while($r=pg_fetch_array($tampil)){
													$lab_analysis=pg_query($dbconn,"SELECT a.nama FROM lab_analysis a, lab_analysis_group_detail b WHERE a.id=b.id_lab_analysis AND b.id_lab_analysis_group='$r[id]'");

													$view=pg_fetch_assoc(pg_query($dbconn,"Select * from lab_analysis_group WHERE id='$r[id_lab_analysis_group]'"));

													$c=pg_fetch_array(pg_query($dbconn,"SELECT COUNT(id) AS tot FROM lab_analysis_group_detail WHERE id_lab_analysis_group='$r[id]'"));
													...
													<tr>
														...
														<td><?php echo $data;?></td>
														<td>
															<button class="btn btn-default btn-xs btnTambahPesanAnalysisGroup" id="<?php echo $r['id'];?>"><i class="icon-plus"></i></button>
														</td>
													</tr>
													<?php
												}
					...
					<div class="col-md-7">
						<fieldset>
							<legend>Lab Order</legend>
							<ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#tabkanan1" role="tab" aria-controls="tabkanan1">Analisa</a>
                                </li>
                                 <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tabkanan2" role="tab" aria-controls="tabkanan2">Anamesa, medisin, dll</a>
                                </li>
                            </ul>
		...
		$('#btnSimpanLaborder').click(function()
		{
			...
			$.ajax({
				type: "POST",
				url: "aksi-tambah-pasien-laborder",
				data: dataString,
				cache: false,
