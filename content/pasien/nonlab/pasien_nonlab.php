...
<div class="card">
	<div class="card-header">
		<strong>Orderan Non-Laboratorium</strong>
	</div>
				...
				<table class="table">
					<thead>
						<tr>
							...
							<th>Nama Non Laboratorium</th>
							<th>Harga</th>
						</tr>
					</thead>
					<tbody>
						<?php
							$tampil=pg_query($dbconn,"SELECT * FROM transaksi_invoice_detail WHERE id_pasien='$id_pasien' AND id_unit='$_SESSION[id_units]' AND status_aktif='Y' AND status_hapus='N' AND jenis='N' ORDER BY id DESC");
							...
							while($r=pg_fetch_array($tampil)){
								...
								$a=pg_fetch_array(pg_query($dbconn,"SELECT nama FROM tindakan WHERE id='$r[id_detail]'"));
								$nama_lab=$a['nama'];
