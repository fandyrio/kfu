...
if (empty($_SESSION['login_user'])){
	...
	if ($module=='gambar' AND $act=='input'){
		...
		echo pg_query($dbconn,"INSERT INTO pasien_gambar (id_pasien, waktu_input, id_user, gambar, status_hapus) 
			VALUES ('$_POST[id_pasien]', '$tgl_sekarang $jam_sekarang', '$_SESSION[login_user]', '$nama_file_unik', 'N')");
		echo "INSERT INTO pasien_gambar (id_pasien, waktu_input, id_user, gambar, waktu_gambar, status_hapus) 
			VALUES ('$_POST[id_pasien]', '$tgl_sekarang $jam_sekarang', '$_SESSION[login_user]', '$nama_file_unik', '$waktu_gambar', 'N')";
