					...
					<table class="table" id="<?php echo $id;?>">
						...
						<tbody>
							<tr >
								...
								<td>
									<input type="text" class="from-control first toClear obat obat0" id="0" style="width:200px;" name="namaObat0" autocomplete="off">
									<input type="hidden" class="from-control" style="width:200px;" name="noUrut" value="0" id="noUrut">
									<input type="hidden" class="from-control" style="width:200px;" name="idResep0" value="R<?php echo $numberOfResep ?>">
									...
									<input type="hidden" class="from-control toClear first obat idobat0" id="id_obat" style="width:200px;" name="idObat0">
									<input type="hidden" class="from-control toClear first" id="stockObat0" style="width:200px;" name="stockObat0">
										...
										<tbody>
											...
											<tr>
												...
												<td style="width:100%;" colspan="4">
													<input type="text" style="width:100%" class="from-control ketResep sediaan" id='sediaan<?php echo $id  ?>' name="sediaan" placeholder='sediaan' autocomplete="off">
											...
											<tr>
												...
												<td id="detailSediaan<?php echo $id ?>">
													<input type="text" class="from-control sediaanDetail" id='sediaanDetail<?php echo $id; ?>' name="sediaanDetail" style="width:170px;" autocomplete="off">
												...
												<td id="detailSediaan<?php echo $id ?>" style="display:none;">
													<input type="text" class="from-control forSediaan" id='idSediaanDetail' name="idSediaanDetail" style="width:170px;" autocomplete="off">
												</td>
												<td colspan="3">
													<input type="text" class="from-control carapakai" id='carapakai<?php echo $id; ?>' name="carapakai" style="width:170px;" autocomplete="off">
													<input type="hidden" name="idCaraPakai" id="idCaraPakai" autocomplete="off">
