...
if (empty($_SESSION['login_user'])){
	...
	if ($module=='tindakan' AND $act=='input'){
		...
		pg_query($dbconn,"INSERT INTO transaksi_invoice_detail (id_pasien, id_kunjungan, jenis, harga, status_aktif, id_user, waktu_input, id_master_kategori_harga, id_detail, kuantitas, status_hapus, id_unit) VALUES ('$_POST[id_pasien]', '$_POST[id_kunjungan]', 'BT', '$harga', 'Y', '$_SESSION[login_user]', '$tgl_sekarang $jam_sekarang', '$id_kategori_harga', '$insert_id', '1', 'N', '$_SESSION[id_units]')");
