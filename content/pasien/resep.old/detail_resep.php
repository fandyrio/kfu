...
$data=pg_fetch_assoc(pg_query($dbconn,"SELECT i.* from pasien_resep i where i.id='".$_POST['id']."' AND i.id_unit='$_SESSION[id_units]'"));
$t=pg_fetch_assoc(pg_query($dbconn,"SELECT qty, id_satuan from pasien_resep_batch  where id_pasien_resep='".$_POST['id']."' "));
...
?>
									...
									<div class="form-group row">
				                      ...
				                      <div class="col-sm-3" >
				                        ...
				                        <input value="<?php echo $t['qty'] 
				                        ?>" 
				                        type="text" name="qty_load" id="qty_load" class="form-control"
				                        <?php if($t['qty'] ){
				                        	echo  "readonly";
				                        }
				                        ?> >
				                      ...
				                      <div class="col-sm-7" style="padding-left: 0px">                      
				                       ...
				                       <div class="form-group row">
				                      <label  class="col-sm-2 form-control-label">Charge</label>

				                      <div class="col-sm-4" >                     
				                        <input value="<?php echo $data['total_cost'];?>" type="text" name="total_cost" class="form-control" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);count_grn();">
				                          
				                      </div>
				                      <label  class="col-sm-2 form-control-label">Harga</label>

				                      <div class="col-sm-4" style="padding-left: 0px">                      
				                        <input value="<?php echo number_format($data['total_cost'],0,',','.');?>" type="text" name="total_sell" class="form-control" readonly>
