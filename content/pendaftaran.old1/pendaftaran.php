			...
			<div class="col-sm-6 col-lg-6" style="height:100px;">
				<div class="card">
					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-9">
								<button type="submit" class="btn btn-sm btn-primary searchByData" value="cari_pendaftaran"><i class="fa fa-dot-circle-o"></i> Tampilkan</button>
...
<div class="row">
			...
			<?php
			if($_GET['no_rekam_medik'] || $_GET['no_handphone'] ||$_GET['nama']  ){
				?>
				...
				success:function(result)
				{
					...
					else
					{
						...
						$.ajax(
						{
							...
							success:function(result)
											{
												location.href="pendaftaran?act=tambahpasien&nama="+nama+"&no_handphone="+mobile+"&address="+address+"&idReservasi="+$("#qr_no").val()+"&idDokter="+data.doctorId+"&tanggal_lahir="+tgl_lahir+"&no_antrian="+result;			
										...
										<div class="col-md-5">
											<fieldset>
												...
												<div class="form-group row">
													...
													<div class="col-md-9">
														<input type="text" id="customerID" name="customerID" class="form-control" placeholder="Customer ID" autofocus value="<?php echo $customerID;?>">
													</div>
												</div>
												...
												<div class="form-group row">
													...
													<div class="col-md-9">
														<select name="id_jenis_pasien" class="form-control" id="id_jenis_pasien">
															<?php
															$tampil =pg_query($dbconn, "SELECT u.* FROM master_kategori_harga u 
												...
												<div class="form-group row">
													...
													<div class="col-md-3">
														<button class="btn btn-sm btn-success" id="check_bpjs">Check</button>
													</div>
												...
												<div class="form-group row">
													...
													<div class="col-md-9">
														<input type="text" id="kode_faskes" class="form-control bpjs" >
													</div>
												...
												<div class="form-group row">
													...
													<div class="col-md-9">
														<input type="text" id="no_rm" name="no_rm" class="form-control" placeholder="No. Rekam Medis" autofocus required value="<?php echo $no_rm_new;?>">
													</div>
												</div>
												<div class="form-group row">
...
{
/*	$("#btnSimpanPasien").click(function(e)
	{
		e.preventDefault();
		alert($("#tanggal_lahir").val());
	});*/
		...
		$.ajax(
		{
			...
			success:function(result, data)
			{
				if(result.error==0)
				{
					...
					$("#kode_faskes").val(result.data.kdProvider+' -  '+result.data.nmProvider).prop('readonly',true);
				}
				else
				{
