...
<html lang="en">
    ...
    <div class="container">
    	<center>
      	...
      	<div class="row loket" style="margin-left: 150px">
      	</div>
	    <div class="audio">
						...
						loket = '<div class="col-md-3">'+
									'<div class="'+ i +
									 ' jumbotron" style="padding-top:20px;padding-bottom:20px;">'+
										...
										'<button class="btn btn-small btn-danger" type="button"><span class="glyphicon glyphicon-credit-card">&nbsp;</span>LOKET '+ i +'</button>'+
									'</div>'+
								'</div>';
						$(".loket").append(loket);
					}
