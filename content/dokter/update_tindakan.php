...
?>
            ...
            <input type="hidden" id="poly" value="<?php echo $_GET[poly_id] ?>">
              ...
              <?php
              $data = pg_fetch_array(pg_query($dbconn,"SELECT * FROM tindakan_dokter_unit WHERE id = '$id'"));
              ...
              ?>    
                <div class="card-body">
                  ...
                  <div class="form-group col-xs-8">
                      <label for="exampleInputEmail1">Persen dokter %</label>
                      <input type="text" name="persen_dokter" class="form-control" value="<?php echo $data['persen_dokter']?>"  >
                  </div>
                   <div class="form-group col-xs-8">
                      <label for="exampleInputEmail1">Persen Perawat %</label>
                      <input type="text" name="persen_perawat" class="form-control" value="<?php echo $data['persen_perawat']?>"  >
                  </div>
