...
error_reporting(0);
			...
			elseif($_POST['jenis']=='N'){
				$a=pg_fetch_array(pg_query($dbconn,"SELECT * FROM tindakan_kategori_harga_unit WHERE id_tindakan='$_POST[id_detail]' and id_kategori_harga='$_POST[id_kategori_harga]' and id_regional='$_SESSION[id_regional]'"));
				$harga="$a[harga]";
