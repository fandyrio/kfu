			...
			<div class="col-sm-12 col-lg-12">
				<div class="card">
					...
					<div class="card-block">
						...
						<!--  -->
						<?php
							$distc=pg_query($dbconn,"SELECT * FROM transaksi_payment WHERE id_invoice='$id'");
							?>
								...
								while($ti=pg_fetch_array($distc)){
									...
									<tr>
										<td><?php if($ti[id_kategori_harga]=='1'){
											echo $p[nama];
											echo "<input type='hidden' name='total_bayar' id='total_bayar' value='$ti[harga_invoice_diskon]'>";
										...
										<td><?php echo formatRupiah($ti[harga_invoice]) ?></td>
										<td><?php echo formatRupiah($ti[diskon]) ?></td>
										<td><?php echo formatRupiah($ti[harga_invoice_diskon]) ?></td>
						...
						<div class="form-group row">
							...
							<label class="col-md-2">EDC</label>
							<div class="col-md-3">
								<select name="id_edc" class="form-control">
									<?php
									$tampil=pg_query($dbconn,"SELECT * FROM master_edc");
									while($r=pg_fetch_array($tampil)){
										echo"<option value='$r[id]'>$r[nama]</option>";
									}
									?>
							...
							<div class="col-md-1"></div>
							<label class="col-md-1">No. Kartu</label>
							<div class="col-md-3">
						...
						<div class="form-group row">
							<label class="col-md-2">Kode Approval</label>
							<div class="col-md-3">
								<input type="text" class="form-control" name="no_kartu">
							</div>
